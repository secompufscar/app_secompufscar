...
public class SectionedGridRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder sectionViewHolder, int position) {
        if (isSectionHeaderPosition(position)) {
            ...
            ((SectionViewHolder)sectionViewHolder).title.setBackgroundColor(mSections.get(position).colorBackground);
    ...
    public static class Section {
        ...
        public Section(int firstPosition, CharSequence title, int colorBackground) {
